...
subprocess.run('C:\\Users\\Anton\\PycharmProjects\\MIPT-physical-process-modeling22-23\\lesson01_10\\explicit Euler scheme\\bin\\Debug\\explicit Euler scheme.exe')
...
ax[0][0].plot(t, z, label="наивная симмуляциия")
