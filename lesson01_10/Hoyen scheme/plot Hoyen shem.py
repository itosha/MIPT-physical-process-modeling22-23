...
subprocess.run('C:\\Users\\Anton\\PycharmProjects\\MIPT-physical-process-modeling22-23\\lesson01_10\\Hoyen scheme\\bin\\Debug\\Hoyen scheme.exe')
...
ax[0][0].plot(t, z, label="симмуляциия")
